  ...
  return (
    <div className="p-6 space-y-6 animate-fade-in">
      <div>
        ...
        <p className="text-muted-foreground">Catalogue produits</p>
      </div>
                ...
                <CardContent>
                  <div className="space-y-3">
                    {getImageSrc(p.imageUrl) && (
                      <img src={getImageSrc(p.imageUrl)} alt={p.nom} className="w-full h-40 object-cover rounded" />
                    )}
